...
const UserNoodels=()=>{
  ...
  const cart=(food) =>{
    ...
    const [UserNoodels,setFoodCategory] = useState([]);
              ...
              <CardBody>
                <Row>
                 {UserNoodels.map( F => 
                                ...
                                <Col lg="3" md="6" sm="6">
                                    {/* //<Row>{F.foodId}</Row> */}
                                    <Row>{<img src="https://th.bing.com/th/id/OIP.ZKZNwJ55lwbMLdCGE9gxbAHaFD?w=290&h=198&c=7&r=0&o=5&dpr=1.3&pid=1.7"/>}</Row>
                                    <center><Row id="itemn">{F.foodTitle}</Row></center>
