...
const UserIcecream=()=>{
  ...
  const cart=(food) =>{
    ...
    const [UserIcecream,setFoodCategory] = useState([]);
              ...
              <CardBody>
                <Row>
                 {UserIcecream.map( F => 
                                ...
                                <Col lg="" md="6" sm="6">
                                    {/* //<Row>{F.foodId}</Row> */}
                                    <Row>{<img src="https://www.bing.com/th?id=OIP.H_QrXcpWLRRgREKjpSwh2wHaE7&w=306&h=204&c=8&rs=1&qlt=90&o=6&dpr=1.3&pid=3.1&rm=2"/>}</Row>
