...
const UserSandwich=()=>{
  ...
  const cart=(food) =>{
    ...
    const [UserSandwich,setFoodCategory] = useState([]);
              ...
              <CardBody>
                <Row>
                 {UserSandwich.map( F => 
                                ...
                                <Col lg="3" md="6" sm="6">
                                    {/* //<Row>{F.foodId}</Row> */}
                                    <Row>{<img src="https://th.bing.com/th/id/OIP.k4JMO5bD97BK3hxEHefrmAHaFP?w=220&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7"/>}</Row>
