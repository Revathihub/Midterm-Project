    ...
    return(
      ...
      <Navbar expand="lg" id="color" >
        ...
        <div className="error">
            ...
            <img src="https://www.bing.com/th?id=OIP.zauFo5LpJiOvon3jJEM3nwHaHa&w=168&h=168&c=8&rs=1&qlt=90&o=6&dpr=1.3&pid=3.1&rm=2" className="imagess"/>

                <h1> There's nothing here</h1>
                    <p> We cannot find what you are looking for.Please check your search query.</p></center>
        </div>
        </>
    );
